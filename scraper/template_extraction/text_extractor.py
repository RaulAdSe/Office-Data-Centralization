...
# Assumim que scraper.models existeix basant-nos en el codi original que em vas passar
from scraper.models import ElementVariable, VariableType

# --- CLASSE 1: LA QUE JA EXISTIA (PER MANTENIR CONSISTÈNCIA) ---
...
class TextExtractor:
    """
    Analitza textos i detecta diferències entre versions de descripcions.
    """
    
    def find_differences(self, text1: str, text2: str) -> List[Dict[str, Any]]:
        """Compara dos textos i retorna una llista amb les diferències."""
